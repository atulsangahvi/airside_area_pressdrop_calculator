...
st.title("Air-Side Area and Pressure Drop Calculator (Adjustable Free Flow %)")
...
free_flow_percent = st.slider("Free Flow Area (%)", min_value=10, max_value=100, value=25)
